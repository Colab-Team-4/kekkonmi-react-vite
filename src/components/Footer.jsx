...
function Footer() {
  return (
    <div className="mx-auto flex w-full flex-col items-center justify-around bg-black p-4 pt-12 md:flex-row md:gap-10 md:p-10 lg:snap-center lg:justify-between lg:px-20">
